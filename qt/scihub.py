...
config = {
    ...
    'BLACK_DOMAIN': [
        'www.google.gf', 'www.google.io', 'www.google.com.lc',
        'scholar.google.cn'
    ],
    'PROXIES': {
        'http': 'http://192.168.1.126:1080',
        'https': 'https://192.168.1.126:1080'
    },
    'DOMAIN':
    'www.google.com',
    'URL_GOOGLE_NEWS':
...
class SciHub(object):
    ...
    def _get_direct_url(self, identifier):
        ...
        return identifier if id_type == 'url-direct' else self._search_direct_url(
            identifier)
...
if __name__ == '__main__':
    ...
    for paper in results['papers']:
        logger.debug(paper)
        paper['meta'] = sh.find_meta(paper)
        pdf = sh.download(paper, destination='pdf_files')
